...
<asp:Content ID="Content" ContentPlaceHolderID="content" runat="server">
    ...
    <asp:Table ID="characterTable" runat="server" Width="100%" >
        <asp:TableRow runat="server">
            ...
            <asp:TableCell runat="server"><asp:TextBox runat="server" ID="tbagility"></asp:TextBox></asp:TableCell>
        ...
        <asp:TableRow runat="server">
            ...
            <asp:TableCell runat="server"><asp:DropDownList runat="server" ID="ddlsmarts"></asp:DropDownList></asp:TableCell>
            <asp:TableCell runat="server"><asp:TextBox runat="server" ID="tbsmarts"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow runat="server">
            ...
            <asp:TableCell runat="server"><asp:TextBox runat="server" ID="tbstrength"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow runat="server">
            ...
            <asp:TableCell runat="server"><asp:TextBox runat="server" ID="tbspirit"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow runat="server">
            ...
            <asp:TableCell runat="server"><asp:TextBox runat="server" ID="tbvigor"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
    </asp:Table>
